  ...
  return (    
    <div className="relative bg-white overflow-hidden">
          ...
          <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
            <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start">
              ...
              <div className="hidden md:block md:ml-10 md:pr-4">
                ...
                <a href="#" className="ml-8 font-medium text-indigo-600 hover:text-indigo-900 focus:outline-none focus:text-indigo-700 transition duration-150 ease-in-out">Iniciar sesión</a>
              </div>
            </nav>
          </div>
          ...
          <div className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-4 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h2 className="text-2xl tracking-tight font-extrabold text-gray-900 sm:text-2xl sm:leading-none md:text-4xl">              
                ENCUENTRA NEGOCIOS CON DOMICILIOS EN TU CIUDAD <span className="text-indigo-600">DURANTE LA CUARENTENA</span>
              </h2>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Conectamos a negocios con permiso para distribuir sus productos con familias que necesitan este servicio para ayudar con el distanciamiento social.
              </p>
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src={deliver} alt="" />
      </div>
    </div>
